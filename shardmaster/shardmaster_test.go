...
func TestBasic(t *testing.T) {
	...
	//fmt.Println("1.25 finished")
	check(t, []int64{gid1}, ck)
	//fmt.Println("1.5 finished")
	cfa[1] = ck.Query(-1)
...
// 		num := common.Nrand()
// 		if int(num/2)%20 == 0 {
// 			ck.Join(int64(num/2)%19+1, []string{"a", "b", "c"})
// 		} else {
// 			ck.Leave(int64(num/2)%19 + 1)
// 		}
